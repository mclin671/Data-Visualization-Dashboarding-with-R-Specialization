...
el_es_ta <- select(dat, educ, edloan, employ, CC18_308a)
el_es_ta
...
trump_approve_disapprove <- recode(el_es_ta$CC18_308a,  '1' = '1', '2' = '1', '3' = '0', '4' = '0')
el_es_ta$trump_approve_disapprove <- trump_approve_disapprove
el_es_ta
...
ft_marry <- filter(dat, employ == '1' & marstat == '1')
summarise(ft_marry, mean_rel = mean(pew_religimp), med_rel = median(pew_religimp))
